...
public class TestSuiteBase extends TestBase implements ITest{
	...
	// check if the suite ex has to be skiped
		...
		public void checkSuiteSkip() throws Exception{
			initialize();
			Log.info("Checking Runmode of Suite DirectSales");
			if(!TestUtil.isSuiteRunnable(suiteXls, "DirectSales Suite")){
				Log.info("Skipped Suite DirectSales as the runmode was set to NO");
				throw new SkipException("RUnmode of Suite DirectSales set to no. So Skipping all tests in Suite DirectSales");
			}
