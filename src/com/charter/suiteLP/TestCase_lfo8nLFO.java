...
/*	XWPFDocument document=null;
	...
	public void LFO8n(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\LP lfo8n_"+streetAddress+" ,"+zipCode+"_"+browserType+".docx"));
	
		   Log.info("================================ Executing TestCase_lfo8nLFO for Test Data: "+streetAddress +"  "+zipCode+"_"+browserType+" ======================================================");
		   Log.info("==================================================================================================================================================");
...
//======================================WebDriver Code ================================================================
			...
			//checkForBrokenLinks();
			//captureScreenshot("lp_lfo8nLFO_home");
			getScreen(document, fos, "lp_lfo8nLFO_home");
			...
			getScreen(document, fos, "lp_lfo8nLFO_StoreFrontPage");
			closeBrowser();
