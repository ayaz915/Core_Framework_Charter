...
public class TestSuiteBase extends TestBase implements ITest{
	...
	public void checkSuiteSkip() throws Exception{
		initialize();
		Log.info("Checking Runmode of Suite LP");
		if(!TestUtil.isSuiteRunnable(suiteXls, "LP suite")){
			Log.info("Skipped Suite LP as the runmode was set to NO");
			throw new SkipException("Runmode of Suite LP set to no. So Skipping all tests in Suite LP");
		}
