...
public class TestCase_lfo7nLFO extends TestSuiteBase{
	...
	public void lfo7n(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\Mobile LP lfo7n_"+streetAddress+" ,"+zipCode+"_"+deviceName+".docx"));
	
		   Log.info("================================ Executing TestCase_Mobile LP lfo7n for Test Data: "+streetAddress+" ,"+zipCode+"_"+deviceName+" ========================");
		   Log.info("==================================================================================================================================================");
...
//======================================WebDriver Code ================================================================
		   ...
		   openMobile(deviceName);
			...
			//captureScreenshot("mobile lp_lfo7nLFO_home");
			getScreen(document, fos, "mobile lp_lfo7nLFO_home");
