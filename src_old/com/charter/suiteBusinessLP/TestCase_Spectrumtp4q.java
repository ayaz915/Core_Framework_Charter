...
public class TestCase_Spectrumtp4q extends TestSuiteBase{
	...
	public void tp4q(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\lpBussiness_Spectrumtp4q "+IndividualName+" ,"+zipCode+"_"+browserType+".docx"));
	
		
		   Log.info("================================ Executing Spectrumtp4q for Test Data: "+IndividualName+" ,"+zipCode+"_"+browserType+" ======================================================");
		   Log.info("==================================================================================================================================================");
...
//======================================WebDriver Code ================================================================
			...
			navigate(Url);
			//waitForTextToBeDisplayed("lpbusiness_txt_homePageContact_css", "855.879.9148");
