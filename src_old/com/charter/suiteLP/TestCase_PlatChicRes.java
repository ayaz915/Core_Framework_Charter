...
public class TestCase_PlatChicRes extends TestSuiteBase {
	...
	public void PlatChicRes(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\LP PlatChicRes_"+streetAddress+" ,"+zipCode+"_"+browserType+".docx"));
	
		   Log.info("================================ Executing TestCase_PlatChicRes for Test Data: "+streetAddress+" ,"+zipCode+"_"+browserType+" ======================================================");
		   Log.info("==================================================================================================================================================");
...
//======================================WebDriver Code ================================================================
		    ...
		    navigate(Url);
			//checkForBrokenLinks();
		    waitForTextToBeDisplayed("lp_PlatChicRes_btn_Find_Deals_Int_id", "FIND DEALS");
			getScreen(document, fos, "lp_PlatChicRes_home");
