...
public class TestCase_AntiSat extends TestSuiteBase {
	...
	public void AntiSat(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\LP AntiSat_"+streetAddress+" "+zipCode+"_"+browserType+".docx"));
	
		   Log.info("================================ Executing TestCase_AntiSat for Test Data: "+streetAddress +"  "+zipCode+"_"+browserType+" ======================================================");
		   Log.info("==================================================================================================================================================");
...
//======================================WebDriver Code ================================================================
		  ...
		  navigate(Url);
			...
			getScreen(document, fos, "lp_AntiSat_home");
			input("lp_AntiSat_txtbx_streetAddress_id", streetAddress);
			input("lp_AntiSat_txtbx_zipCode_id", zipCode);
			click("lp_AntiSat_btn_checkavailability_id");
			wait1();
			checkForLacalizationError(CONFIG.getProperty("LacalizationError_com"));
			getScreen(document, fos, "LacalizationError_com");
			closeBrowser();
