...
public class TestCase_lfo9nLFO extends TestSuiteBase {
	...
	public void LFO9n(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\LP lfo9n_"+streetAddress+" ,"+zipCode+"_"+browserType+".docx"));
	
		   Log.info("================================ Executing TestCase_lfo9nLFO for Test Data: "+streetAddress+" ,"+zipCode+"_"+browserType+" ======================================================");
		   Log.info("==================================================================================================================================================");
...
//======================================WebDriver Code ================================================================
		  ...
		  openBrowser(browserType);
			...
			//captureScreenshot("lp_lfo9nLFO_home");
			getScreen(document, fos, "lp_lfo9nLFO_home");
			input("lp_lfo8&9nLFO_txtbx_streetAddress_id", streetAddress);
			input("lp_lfo8&9nLFO_txtbx_zipCode_id", zipCode);
			click("lp_lfo8&9nLFO_btn_go_id");
			wait1();
		    checkForLacalizationError(CONFIG.getProperty("LacalizationError_com"));
					...
					getScreen(document, fos, "lp_lfo9nLFO_StoreFrontPage");
					closeBrowser();
