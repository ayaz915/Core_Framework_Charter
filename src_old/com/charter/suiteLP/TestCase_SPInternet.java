...
public class TestCase_SPInternet extends TestSuiteBase {
	...
	public void SPInternet(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\LP SPInternet_"+streetAddress+" ,"+zipCode+"_"+browserType+".docx"));
	
		
		   Log.info("================================ Executing TestCase_SPInternet for Test Data: "+streetAddress+" ,"+zipCode+"_"+browserType+" ======================================================");
		   Log.info("==================================================================================================================================================");
...
//======================================WebDriver Code ================================================================
		...
		getScreen(document, fos, "lp_SPInternet_home");
