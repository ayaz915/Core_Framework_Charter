...
public class TestSuiteBase extends TestBase implements ITest {
	...
	public void checkSuiteSkip() throws Exception{
		initialize();
		Log.info("Checking Runmode of Suite CharterCom");
		if(!TestUtil.isSuiteRunnable(suiteXls, "CharterCom Suite")){
			Log.info("Skipped Suite CharterCom as the runmode was set to NO");
			throw new SkipException("Runmode of Suite CharterCom set to no. So Skipping all tests in Suite CharterCom");
		}
