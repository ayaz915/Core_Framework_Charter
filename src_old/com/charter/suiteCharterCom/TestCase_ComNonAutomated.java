...
public class TestCase_ComNonAutomated extends TestSuiteBase{
	...
	public void nonAutomatedBuyFlow(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\ComNonAutomated_"+streetAddress+" ,"+zipCode+"_"+browserType+".docx"));
