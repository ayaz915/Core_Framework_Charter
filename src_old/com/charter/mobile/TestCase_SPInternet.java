...
public class TestCase_SPInternet extends TestSuiteBase{
	...
	public void SPInternet(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\Mobile LP SPInternet_"+streetAddress+" ,"+zipCode+"_"+deviceName+".docx"));
	
		   Log.info("================================ Executing TestCase_Mobile LP SPInternet for Test Data: "+streetAddress+" ,"+zipCode+"_"+deviceName+" ======================================================");
		   Log.info("==================================================================================================================================================");
...
//======================================WebDriver Code ================================================================
		   ...
		   waitForTextToBeDisplayed("lp_SPI100Mb&SPIInternet_btn_go_id", "GO");
			getScreen(document, fos, "mobile lp_SPInternet_home");
