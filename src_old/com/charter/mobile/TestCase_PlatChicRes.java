...
public class TestCase_PlatChicRes extends TestSuiteBase{
	...
	public void PlatChicRes(
		...
		fos = new FileOutputStream(new File(System.getProperty("user.dir")+"\\Documented Screenshots\\Mobile LP PlatChicRes_"+streetAddress+" ,"+zipCode+"_"+deviceName+".docx"));
	
		   Log.info("================================ Executing TestCase_Mobile LP PlatChicRes for Test Data: "+streetAddress+" ,"+zipCode+"_"+deviceName+" =====================================");
		   Log.info("==================================================================================================================================================");
