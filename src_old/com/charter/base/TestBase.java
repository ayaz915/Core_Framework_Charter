...
import com.charter.util.ErrorUtil;
...
public class TestBase {
	...
	public static Xls_Reader suiteCharterComxls=null;
	public static Xls_Reader suiteSpectrumBusinessxls=null;
	public static Xls_Reader suiteDirectSalesxls=null;
	public static Xls_Reader suiteBaexls=null;
	public static Xls_Reader suiteAffiliatesxls=null;
	public static Xls_Reader suiteLPxls=null;
	public static Xls_Reader suiteMobilexls=null;
	public static Xls_Reader suitebusinessLP=null;
	public static Xls_Reader suiteMiscellaneousxls=null;
	public static Xls_Reader suiteabcxls=null;
	...
	public static void initialize() throws Exception{
		...
		FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+"//src//com//charter//config/config.properties");
		CONFIG.load(ip);
			
		OR = new Properties();
		ip = new FileInputStream(System.getProperty("user.dir")+"//src//com//charter//config/OR.properties");
		OR.load(ip);
		Log.info("Loaded Property files successfully");
		Log.info("Loading XLS Files");

		// xls file
		suiteCharterComxls = new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//CharterCom suite.xlsx");
		suiteSpectrumBusinessxls = new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//SpectrumBusiness suite.xlsx");
		suiteDirectSalesxls = new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//DirectSales suite.xlsx");
		suiteBaexls = new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//Bae suite.xlsx");
		suiteAffiliatesxls = new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//Affiliates suite.xlsx");
		suiteLPxls = new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//LP suite.xlsx");
		suiteMobilexls= new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//Mobile suite.xlsx");
		suiteMiscellaneousxls= new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//Miscellaneous suite.xlsx");
		suitebusinessLP=new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//BusinessLP suite.xlsx");
		suiteabcxls=new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//abc suite.xlsx");
		suiteXls = new Xls_Reader(System.getProperty("user.dir")+"//src//com//charter//xls//Suite.xlsx");
...
//================================== your own functions===============================================\\
			...
			public static void checkForLacalizationError(String url) throws Exception{
				
				Log.info("checking for Lacalization Error");
				if(driver.getCurrentUrl().contains(url)){
					Log.info("Not a valid Address");
					captureScreenshot("LacalizationErrorPage");					
					fail=true;
					throw new Exception(" Stoping the script....!!!!");
					
				}
				else{
					Log.info("No Problem with the Address");
				}
			 }
			 ...
			 public static void getOrderSummary() throws Exception{
					...
					try{
					String OrderTotal= driver.findElement(By.xpath(OR.getProperty("txt_orderTotal_xpath"))).getText();
					String MonthlyCosts= driver.findElement(By.xpath(OR.getProperty("txt_monthlyCost_xpath"))).getText();
					String MonthlySavings= driver.findElement(By.xpath(OR.getProperty("txt_MonthlySavings_xpath"))).getText();
					}catch(Throwable t){
						// report error
		        	  
						ErrorUtil.addVerificationFailure(t);			
						fail=true;
						Log.error("Not able to find Element:-- " );
						throw new Exception(" Stoping the script....!!!!");	
		           }	
					}		
			

			 public static void verifyMonthlyCost(String identifier, String monthlyCost) throws Exception{
		    		String strng = null;
		    			Log.info("verifying the Monthly Cost "+ monthlyCost);
		    			...
		    			try{
		    			Assert.assertEquals(strng, monthlyCost);
		    			Log.info(monthlyCost+" is verified successfully");
		    			}catch(Throwable t){
		     				ErrorUtil.addVerificationFailure(t);
		     				fail=true;
		     				Log.error("Not able to verify "+ t.getMessage());
